...
def feedback_func(): #coaching text 생성
    ...
    if pose=='passe':
        ...
        rd=getAngle3P((point_in[22], point_in[23]),(point_in[24], point_in[25]),(point_in[26], point_in[27]),"CCW")#body 25기준으로 바꾼상태
        if ld<rd and ld > 45:
            msg="Raise right leg " +str(round(ld-45,1))+"deg more"
        elif rd< ld and rd> 45:
            msg="Raise left leg " +str(round(rd-45,1))+"deg more"
        else:
            msg="Good"
    ...
    if pose=='plie':
        ...
        if ld > 100 or rd > 100:
            msg="Bend your knee " +str(round(max(ld,rd)-100,1))+"deg more"
        else:
            msg="Good"
    ...
    if pose=='arabesque':
        ...
        if leg1>leg2 and leg2<90:
            msg="Raise right leg " +str(round(90-leg2,1))+"deg more"
        if leg2>leg1 and leg1<90:
            msg="Raise left leg " +str(round(90-leg1,1))+"deg more"
        else:
            msg="Good"
...
def output_keypoints_with_lines(frame, POSE_PAIRS):
    ...
    for pair in POSE_PAIRS:
        ...
        if points[part_a] and points[part_b]:
            ...
            cv2.putText(frame, msg, (30, 200), font, 4,(0,0,0),4, cv2.LINE_AA)
